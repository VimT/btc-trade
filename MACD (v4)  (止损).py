start_time = "2017-08-11 15:00:00"#time.strftime('%Y-%m-%d %H:%M:%S',time.localtime(time.time()+2*60*60))
end_time = "2017-08-12 15:00:00"#time.strftime('%Y-%m-%d %H:%M:%S',time.localtime(time.time()+22*60*60))
...
def main():
    ...
    while True:
        ...
        #打印行情
        Log("行情: "+str(ticker.Buy)+"  "+str(select)+"  "+str(stop_loss)+"  "+str(round(macd[-1]))+" "+str(round(macd[-2])))
